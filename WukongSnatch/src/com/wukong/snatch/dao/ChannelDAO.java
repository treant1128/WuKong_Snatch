 ...
 * 
 * @see com.wukong.snatch.pojo.Channel
...
public class ChannelDAO extends BaseHibernateDAO {
	...
	public Channel findById(java.lang.Integer id) {
		...
		try {
			Channel instance = (Channel) getSession().get(
					"com.wukong.snatch.pojo.Channel", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Channel instance) {
		...
		try {
			List results = getSession().createCriteria(
					"com.wukong.snatch.pojo.Channel").add(
	...
	public List findByChannelUrl(Object channelUrl) {
		return findByProperty(CHANNEL_URL, channelUrl);
	}
